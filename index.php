...
if (isset($_POST["signup"])) {
  ...
  if ($password !== $cpassword) {
    ...
    $sql = "INSERT INTO users (full_name, email, password, token, status) VALUES ('$full_name', '$email', '$password', '$OTP', '0')";
    ...
    if ($result) {
      ...
      <p><a href='{$base_url}verify-email.php?token={$OTP}'>Verify Email</a></p>
      </body>
      </html>
      ";
      ...
      try {
        ...
        $mail->send();
        echo "<script>alert('We have sent a OTP link to your email - {$email}.');</script>";
      } catch (Exception $e) {
